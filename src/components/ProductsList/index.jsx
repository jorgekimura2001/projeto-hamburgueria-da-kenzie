    ...
    return (
        <Container>
                {   filteredProducts.length <= 0 ?
                    ...
                    :
                    filteredProducts.map((product) => <Product category={product.category} name={product.name} price={product.price} handleClick={handleClick} key={product.id} img={product.img} id={product.id}/>)
                }
        </Container>
    )
}
